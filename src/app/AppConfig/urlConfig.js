...
// export const SUBSCRIPTION_PLANS =
//   PAYMENT_BASE_URL +
//   "/plans/platformPlans?country={COUNTRY_CODE}&platform=website&system=weyyak&language={LANGUAGE_CODE}";

  // export const SUBSCRIPTION_PLANS =
//   PAYMENT_BASE_URL +
//   // "?c=Product_platform_plan&m=product_platform_plans_api&country={COUNTRY_CODE}&platform=website&system=weyyak&language={LANGUAGE_CODE}";
// "/index.php?c=Product_platform_plan&m=product_platform_plans_api&country={COUNTRY_CODE}&platform=website%20&system=weyyak&language={LANGUAGE_CODE}"
...
// export const SUBSCRIPTION_ENTITLEMENT =
//   PAYMENT_BASE_URL +
//   "?c=orders&m=orders_api&user_id={USERID}&include_all={IS_INCLUDE_ALL}&language={LANGUAGE_CODE}";
// Test user with mutiple subscription
// export const SUBSCRIPTION_ENTITLEMENT =
//   "http://paymentapiqa.weyyak.com/orders/orderDetails?user_id=3fc56303-002a-e911-8186-02169856e681&include_all=true";
export const CANCEL_SUBSCRIPTION =
  PAYMENT_BASE_URL + "/payment/cancelSubscription/{ORDER_ID}";
