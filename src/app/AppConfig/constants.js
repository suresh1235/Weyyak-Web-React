...
export const BUILD_VERSION_NUMBER = "1.0.7.4";
...
// export const VIDEO_AD_URL = "https://pubads.g.doubleclick.net/gampad/ads?sz=640x360&iu=/7229/n7729.testsite/Weyyak&ciu_szs=320x50,320x100,728x90,970x90,970x250&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=[referrer_url]&cust_params=platform%3Dweb&language%3Dar&description_url=https://weyyak.z5.com&ad_rule=1&correlator=&cmsid=2499579&vid={VIDEO_ID}"
...
export const SUBSCRIPTION_CANCEL_ACTION = "clicked";
...
// export const FACEBOOK_ID = "290597248278499"; //Nikunj test app
...
//Coupons
export const COUPON_MINIMUM_LENGTH = 6;
