...
class PaymentEnterMobile extends BaseContainer {
  ...
  componentDidMount() {
    ...
    if (!this.props.oSelectedPlan) {
      ...
      this.oUserObject = common.getCookie(CONSTANTS.COOKIE_USER_OBJECT)
        ? JSON.parse(common.getCookie(CONSTANTS.COOKIE_USER_OBJECT))
        : null;
      this.oUserToken = common.getCookie(CONSTANTS.COOKIE_USER_TOKEN)
    ...
    if (
     ...
     if (
        ...
        if (
          response &&
          response.error_code &&
          CONSTANTS.PAYMENT_OPERATOR_DU === this.state.operator
        ){
          switch(response.error_code){
            case CONSTANTS.ERROR_CODE_ETISALAT_NUMBER_ALREADY_EXISTS:
              message = oResourceBundle.etisalat_number_exists;
  ...
  render() {
    ...
    if (this.props.oSelectedPlan) {
      ...
      const planPrice1 =
        this.props.oSelectedPlan.price + (this.props.oSelectedPlan.currency == "GBP" ? '<span > &#163;</span>':this.props.oSelectedPlan.currency== "CAD"?'<span>&#x24;</span>': this.props.oSelectedPlan.currency);
      const text = this.props.oSelectedPlan.country == "BH"? oResourceBundle.free_for4: oResourceBundle.free_for3;
          ...
          <div className="conditions-container">
           ...
           <div>
            ...
            <div className="by-clicking3">
              ...
              {this.props.locale === "en"?<a className="link" href="https://weyyak.z5.com/en/static/term-en">click here</a>:<a className="link" href="https://weyyak.z5.com/ar/static/term-ar">انقر هنا</a>}
            </div>:""}
            <br />
