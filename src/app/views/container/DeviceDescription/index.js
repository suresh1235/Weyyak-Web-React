...
class DeviceDescription extends BaseContainer {
  ...
  render() {
    return (
      <div className="plans-description-container">
        <div className="try-for-free">{oResourceBundle.subscribe_landing_text}</div>
        <div className="try-for-free1">{oResourceBundle.pair_devices_text}</div>
        <div className="try-for-free2">{oResourceBundle.landing_text}</div>
...
export default withTracker(connect(mapStateToProps)(DeviceDescription));
